...
export const buildParsingPrompt = ({ logLine, variableHints }: ParsingPromptOptions): string => {
  ...
  return [
    ...
    'Use control-sequence placeholders for each variable: insert `\\u001b]9;slot=<name>\\u0007` where the variable value should go. Do NOT include the value inline.',
    'Provide the actual values separately in a variables map.',
    ...
    '{',
    '  "template": "raw log with placeholders (\\u001b]9;slot=name\\u0007) inserted instead of variable values",',
    '  "variables": {',
    '    "name1": "value1",',
    '    "name2": "value2"',
    '  }',
    ...
    'Template: [\\u001b]9;slot=ts\\u0007] Library-AP path=\\u001b]9;slot=path\\u0007',
    'Variables: { "ts": "Dec 04 04:47:44 2005", "path": "/tmp/a.log" }',
    '',
    'Log line:',
    logLine,
  ].join('\n');
